...
export { default as TestForm } from '../../components/TestForm.vue'
...
export const LazyTestForm = import('../../components/TestForm.vue' /* webpackChunkName: "components/test-form" */).then(c => wrapFunctional(c.default || c))
